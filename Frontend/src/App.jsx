...
function App() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header userName={user} userRole={userRole} onLogout={handleLogout} cartCount={2} notificationCount={3} />
      <main className="container mx-auto px-4 py-8">
        {userRole === "buyer" ? <BuyerExperience /> : <SellerExperience sellerName={user} />}
      </main>
    </div>
  )
}
